...
Game::Game() {
    ...
    Resource::mTexture.load(TextureIdentifier::MARIO_N_FLAGSLIP, "resource\\Texture\\Spritesheet\\Mario_N_FlagSlip.png");
    ...
    Resource::mTexture.load(TextureIdentifier::MARIO_S_FLAGSLIP, "resource\\Texture\\Spritesheet\\Mario_S_FlagSlip.png");
    ...
    Resource::mTexture.load(TextureIdentifier::MARIO_F_FLAGSLIP, "resource\\Texture\\Spritesheet\\Mario_F_FlagSlip.png");
    ...
    Resource::mTexture.load(TextureIdentifier::LUIGI_N_FLAGSLIP, "resource\\Texture\\Spritesheet\\Luigi_N_FlagSlip.png");
    ...
    Resource::mTexture.load(TextureIdentifier::LUIGI_S_FLAGSLIP, "resource\\Texture\\Spritesheet\\Luigi_S_FlagSlip.png");
